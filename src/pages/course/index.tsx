...
import CoursePriceBox from "../../components/CoursePriceBox";
...
function CourseDetail() {
  ...
  //     if (coupon) {
  //       navigate(
  //         `/payment/checkout/course/${course.id}?discountPercent=${coupon.discountPercent}&couponCode=${coupon.code}`
  //       );
  //     } else {
  ...
  const courseDemo = {
    title: "Complete React + TypeScript Bootcamp 2025",
    rating: 4.7,
    ratingCount: 12345,
    priceText: "₫399.000",
  };
  ...
  const handleBuy = () => {
    // TODO: điều hướng thanh toán, mở modal, gọi API, v.v.
    console.log("buy");
  };
  ...
  return (
    <>
      {/* Sticky header */}
      <CourseStickyHeader
        title={courseDemo.title}
        rating={courseDemo.rating}
        ratingCount={courseDemo.ratingCount}
        priceText={courseDemo.priceText}
        onBuy={handleBuy}
      />
      ...
      <section className="course-hero">
        <div className="container">
          <h1 className="course-hero__title">{courseDemo.title}</h1>
          <div className="course-hero__sub">
            Build production-ready apps with modern patterns.
          </div>
          <div className="course-hero__meta">
            ★ {courseDemo.rating.toFixed(1)} ({courseDemo.ratingCount})
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="course-grid">
            <article className="course-content">
              ...
              <ul>
                <li>State management, hooks nâng cao</li>
                <li>Form, validation, performance</li>
                <li>Architecture & testing</li>
              </ul>

              <h2>Curriculum</h2>
              <p>… nội dung bài giảng dài để test scroll …</p>
...
//               ({course?.ratingCount} xếp hạng)
//             </div>
//           </div>
//           <div className="instructor-name">
//             Được tạo bởi {course?.createdBy}
//           </div>
//         </div>
...
//         <div className="left">
//           {course && course.objectives && course.objectives.length > 0 && (
//             <div className="lessons-content">
//               <div className="lesson-header">Nội dung bài học</div>
//               <div className="lesson-content">
//                 {course &&
//                   course.objectives?.map((objective, index) => (
//                     <div key={`objective-${index}`} className="lesson">
//                       <FaCheck /> <span>{objective}</span>
//                     </div>
//                   ))}
//               </div>
//             </div>
...
//                     {course?.totalLectureCourse} bài học
//                   </div>
//                   <div className="total-time">
//                     Thời lượng {course?.totalDurationCourse}
//                   </div>
//                 </div>
...
//                   <h2 className="requirement-header">Yêu cầu</h2>
//                   <ul className="requirement-item">
//                     {course.requirements.map((item, index) => (
//                       <li key={`requirement-course-detail-${index}`}>
//                         <span>{item}</span>
//                       </li>
//                     ))}
//                   </ul>
...
//               <h2 className="instructor-header">Giảng viên</h2>
//               <span>{course?.user?.fullName}</span>

//               <div className="instructor-course-wrapper">
//                 <img
//                   src={course?.user?.photo}
//                   alt="instructor-image"
//                   onClick={() => handleNavigateToInstructor(course?.user?.id)}
//                 />
...
//                     <span>
//                       {course?.user?.averageRating} xếp hạng giảng viên
//                     </span>
//                   </div>
//                   <div className="intructor-course-right-item">
//                     <IoPeopleSharp />
...
//             {reviewsCourse && reviewsCourse.length > 0 && (
...
//                     reviewsCourse.map((review) => (
//                       <Review
//                         review={review}
//                         key={`review-of-course-${review.id}`}
//                         isFilter={false}
//                       />
//                     ))}
//                 </div>
//                 <Button onClick={showModal} className="btn-review-showmore">
//                   Hiện thêm đánh giá
//                 </Button>
//               </div>
//             )}
...
//                 <h2 className="desc-header">Mô tả</h2>
//                 <div
...
//               {course && (
//                 <span className="course-action-price">
//                   <span>
//                     {course.free == true
//                       ? "Miễn phí"
...
//                   {course.free == false &&
//                     course.price != course.discountedPrice && (
//                       <span className="course-discountPrice">
//                         {formatCurrency(course.price)}
//                       </span>
//                     )}
//                 </span>
...
//               {course?.learning == false &&
//                 isLoggin == true &&
//                 checkIsAddedToCart() == true && (
//                   <Button
//                     className="btn-add-to-cart"
//                     onClick={handleRedirectToCarts}
//                   >
//                     Chuyển đến giỏ hàng
//                   </Button>
//                 )}
//               {course?.learning == true && (
//                 <Button className="btn-buy-now" onClick={handleLearning}>
//                   Chuyển đến khóa học
//                 </Button>
//               )}
//               {course?.learning == false && course?.free == true && (
//                 <Button className="btn-buy-now" onClick={handleLearning}>
//                   Đăng ký khóa học
//                 </Button>
//               )}
//               {course?.learning == false && course?.free == false && (
//                 <Button
...
//       <Modal
//         width={900}
//         rootClassName="review-course-modal"
//         open={isModalOpen}
//         onOk={handleOk}
...
//               <div
//                 className={`review-filter-left-item ${
//                   ratingSelected != 5 && ratingSelected != 0 ? "active" : ""
//                 }`}
//               >
//                 <div
//                   className="review-filter-left-rating"
//                   onClick={() => loadMoreData(5, "rate")}
//                 >
//                   <Progress
//                     className="review-filter-left-progress"
//                     percent={reviewPercent?.percentFiveStar}
//                     size="small"
//                     showInfo={false}
//                   />
//                   <Rate
//                     className="review-filter-left-rate"
//                     allowHalf
//                     disabled
//                     defaultValue={5}
//                   />
...
//               <div
//                 className={`review-filter-left-item ${
//                   ratingSelected != 4 && ratingSelected != 0 ? "active" : ""
//                 }`}
//               >
//                 <div
//                   className="review-filter-left-rating"
//                   onClick={() => loadMoreData(4, "rate")}
//                 >
//                   <Progress
//                     className="review-filter-left-progress"
//                     percent={reviewPercent?.percentFourStar}
//                     size="small"
//                     showInfo={false}
//                   />
//                   <Rate
...
//               <div
//                 className={`review-filter-left-item ${
//                   ratingSelected != 3 && ratingSelected != 0 ? "active" : ""
//                 }`}
//               >
//                 <div
//                   className="review-filter-left-rating"
//                   onClick={() => loadMoreData(3, "rate")}
//                 >
//                   <Progress
//                     className="review-filter-left-progress"
//                     percent={reviewPercent?.percentThreeStar}
//                     size="small"
//                     showInfo={false}
//                   />
//                   <Rate
...
//               <div
//                 className={`review-filter-left-item ${
//                   ratingSelected != 2 && ratingSelected != 0 ? "active" : ""
//                 }`}
//               >
//                 <div
//                   className="review-filter-left-rating"
//                   onClick={() => loadMoreData(2, "rate")}
//                 >
//                   <Progress
//                     className="review-filter-left-progress"
//                     percent={reviewPercent?.percentTwoStar}
//                     size="small"
//                     showInfo={false}
//                   />
//                   <Rate
...
//               <div
//                 className={`review-filter-left-item ${
//                   ratingSelected != 1 && ratingSelected != 0 ? "active" : ""
//                 }`}
//               >
//                 <div
//                   className="review-filter-left-rating"
//                   onClick={() => loadMoreData(1, "rate")}
//                 >
//                   <Progress
//                     className="review-filter-left-progress"
//                     percent={reviewPercent?.percentOneStar}
//                     size="small"
//                     showInfo={false}
//                   />
//                   <Rate
...
//                   <Review
//                     review={review}
//                     key={`review-of-course-all-${review.id}`}
//                     isFilter={true}
//                   />
//                 ))}
//               <Button
//                 onClick={() => loadMoreData(ratingSelected, "more")}
//                 className="btn-review-modal-showmore"
//               >
//                 Hiện thêm đánh giá
//               </Button>
//             </div>
