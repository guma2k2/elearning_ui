...
function PopoverCart(props: PropType) {
    ...
    return (
        <div className="popover-cart-container">
                                ...
                                <Fragment key={`cart-item-${index}`}>
                                    <div className="popover-carts-item">
                                        ...
                                        <div className="popover-carts-item-right">
                                            ...
                                            <span>{cart.course.free ? "Free" : formatCurrency(cart.course.price)}</span>
                                        </div>
                                    </div>
            ...
            <div className="popover-cart-bottom">
                <span className="popover-cart-bottom-price">Total: {formatCurrency(totalPrice)}</span>
                <Button variant="primary" onClick={handleRedirectToCartPage} className="popover-cart-bottom-btn">
                    Go to Cart Page
                </Button>
            </div>
        </div>
