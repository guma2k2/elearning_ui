...
function Header() {
  ...
  const { categoryParents } = useAppSelector(
  ...
  const handleFilterByCategory = (catName: string) => {
    let url = `/courses/search?catName=${catName}`;
  ...
  const handleFilterByTopicId = (topicId: number) => {
    let url = `/courses/search?topicId=${topicId}`;
    setToggleNavbar(false);
    setActiveParentId(null);
    setActiveChildId(null);
    navigate(url);
        ...
        <div className="header__inner">
          <div className="header-left">
            <div className="header-menu d-none d-lg-block">
              <MdMenu
                className="header-menu__icon icon"
                  ...
                  <div className="dropdown__inner">
                    {isLoggin === false ? (
                      <div className="dropdown__action">
                        <Button
                          variant="text"
                          className="d-none d-md-flex dropdown__btn"
                        >
                          Sign in
                        </Button>
                        <Button
                            ...
                            >
                              ...
                              >
                                <span
                                  ...
                                  onClick={() =>
                                    handleFilterByCategory(parent.name)
                                  }
                                >
                                  {parent.name}
                                </span>
                                        ...
                                        return (
                                          <li
                                            className={clsx(
                                              ...
                                              {
                                                "is-open":
                                                  activeChildId === cat.id, // mở panel con cho parent này
                                              }
                                            )}
                                            key={`cat-${cat.id}`}
                                            onMouseEnter={() =>
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              <MdKeyboardArrowRight
                                                className="icon"
                                                onClick={handleOpenSubmenuTopic(
                                                  cat.id
                                                )}
                                              />
                                            </a>
            ...
            {toggleNavbar && (
              <div className="header__dismiss">
                <Button
                  variant="circle"
                  className="navbar-dismiss"
                  onClick={handleToggleNav}
          ...
          <div className={clsx("header-form__wrapper", { show: openFilter })}>
            <Popover
              ...
              rootClassName={clsx("popover-search", {
                "popover-search--full": openFilter,
              })}
              open={isOpen}
              trigger="click"
          ...
          <div className="header-action">
            <Button
              variant="text"
              className="d-none d-sm-flex header-action__search-btn"
              onClick={handleShowFilter}
            >
            ...
            {isLoggin ? (
              <>
                ...
                >
                  <Button variant="text" className="d-md-none">
                    ...
                    <span className="cart_quantity">5</span>
                  </Button>
                </Popover>
                ...
                >
                  <div className="header-avatar">
                    <img
                      src={
                        auth?.user.photoURL ? auth?.user.photoURL : fakeAvatar
                      }
                      alt=""
              ...
              <>
                ...
                >
                  <Button
                    className="header-language__btn d-lg-none"
